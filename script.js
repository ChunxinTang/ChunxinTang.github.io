...
function initLoadingScreen() {
    ...
    loadingScreen.innerHTML = `
        <div class="loading-content">
            <div class="vinyl-package">
                <div class="package-box">
                    <div class="package-lid"></div>
                    <div class="package-body"></div>
                </div>
                <div class="vinyl-disc-unboxed">
                    <div class="vinyl-disc"></div>
                    <div class="vinyl-label">
                        <span class="artist-name">Chunxin Tang</span>
                        <span class="album-title">Personal Website</span>
                    </div>
                </div>
            </div>
            <p class="loading-text">Unboxing my story...</p>
        </div>
    `;
    ...
    loadingStyles.textContent = `
        ...
        .package-box {
            ...
            animation: packageShake 0.8s ease-in-out;
        }
        ...
        @keyframes lidOpen {
            ...
            100% { transform: translateY(-20px) rotateX(90deg); opacity: 0; }
        }
